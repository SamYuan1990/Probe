        ...
        request
            ...
            .send({
                ...
                cmd: `[
                    ...
                    {"order":9,"cmdType":"Tape","args":["docker","run","--name","tape","-e","TAPE_LOGLEVEL=debug","--network","mysite0","-v","/tmp/minifab:/config","ghcr.io/hyperledger-twgc/tape","tape","-c","/config/config.yaml","-n","500"]},
