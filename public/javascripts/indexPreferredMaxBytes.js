...
xmlhttp.open('GET', '../api/get?data=BatchTimeout&orderby=PreferredMaxBytes', false);
xmlhttp.send();
...
xmlhttp.open('GET', '../api/get?data=MaxMessageCount&orderby=PreferredMaxBytes', false);
xmlhttp.send();
const MaxMessageCount = xmlhttp.responseText.split(',');

xmlhttp.open('GET', '../api/get?data=AbsoluteMaxBytes&orderby=PreferredMaxBytes', false);
xmlhttp.send();
const AbsoluteMaxBytes = xmlhttp.responseText.split(',');

xmlhttp.open('GET', '../api/get?data=PreferredMaxBytes&orderby=PreferredMaxBytes', false);
xmlhttp.send();
