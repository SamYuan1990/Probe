...
xmlhttp.open('GET', '../api/get?data=BatchTimeout&orderby=MaxMessageCount', false);
xmlhttp.send();
...
xmlhttp.open('GET', '../api/get?data=MaxMessageCount&orderby=MaxMessageCount', false);
xmlhttp.send();
const MaxMessageCount = xmlhttp.responseText.split(',');

xmlhttp.open('GET', '../api/get?data=AbsoluteMaxBytes&orderby=MaxMessageCount', false);
xmlhttp.send();
const AbsoluteMaxBytes = xmlhttp.responseText.split(',');

xmlhttp.open('GET', '../api/get?data=PreferredMaxBytes&orderby=MaxMessageCount', false);
xmlhttp.send();
